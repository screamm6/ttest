class OnlineMinesGame {
    ...
    handlePlayerJoined(player) {
        console.log('👤 Добавление игрока:', player);
    ...
    handlePlayerLeft(playerId) {
        console.log('👋 Удаление игрока:', playerId);
    ...
    updateUI() {
        ...
        if (onlineCountElement && globalOnlineElement) {
            ...
            console.log('👥 Обновление онлайн счетчика:', onlineCount);
    ...
    updatePlayersList() {
        ...
        console.log('📝 Обновление списка игроков, всего:', this.players.size);
